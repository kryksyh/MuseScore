...
public:
    ...
    MOCK_METHOD(void, setWindowRoot, (AccessibleObject*), (override));
    MOCK_METHOD(AccessibleObject*, windowRoot, (), (const, override));
    MOCK_METHOD(void, registerWindow, (QWindow*), (override));
